...
This is the privacy policy for the **AppName**, macOS Application that is available on the macOS App Store and TestFlight.

**AppName** does not collect any user data. No personal information is transmitted, stored, or used by this application.

**AppName** does not use any third-party analytics or tracking tools. It does not contain any in-app purchases or advertisements.
