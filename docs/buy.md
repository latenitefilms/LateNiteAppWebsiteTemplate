...
**AppName** is a one-time payment of **USD$9.99** on the **Mac App Store**.

There is no free trial.

> [:icon-desktop-download: Click here to **buy** on the **Mac App Store**](https://apps.apple.com/app/AppName/id6759045715)
...
You can use **AppName** to "unlock" CommandPost!
